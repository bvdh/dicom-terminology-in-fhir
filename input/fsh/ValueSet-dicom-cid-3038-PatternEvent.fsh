...
The content in this ValueSet is based on [CID 3038](https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_3038.html).
"""
...
* DICOM_DCM_CodeSystem#130413 //"Hyperventilation begin" 

* DICOM_DCM_CodeSystem#130414 //"Hyperventilation end" 

* DICOM_DCM_CodeSystem#130415 //"Post-hyperventilation" 
