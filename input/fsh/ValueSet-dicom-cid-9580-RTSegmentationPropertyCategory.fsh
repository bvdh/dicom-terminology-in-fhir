...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID Segment Annotation Type and RT ROI Identification Context Group  DCM  RT Target    DCM  RT Geometric Information    DCM  External Body Model    DCM  Patient-Attached Dose Control Object    DCM  Fixation or Positioning Device    DCM  Brachytherapy Device    DCM  Non-specific Volume    DCM  Radiotherapy Dose Region   D DCM  Radiotherapy Fiducial   D
"""
