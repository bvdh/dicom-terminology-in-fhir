ValueSet    : CID_3043
Id          : dicom-cid-3043-DigitalWaveformFilter
Description :
"""
Coding Scheme Designator Code Value Code Meaning DCM  FIR filter DCM  CIC filter DCM  IIR filter DCM  Biquad filter
"""
