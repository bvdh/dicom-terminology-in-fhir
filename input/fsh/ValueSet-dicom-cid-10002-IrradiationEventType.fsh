...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Fluoroscopy   DCM  Stationary Acquisition   DCM  Stepping Acquisition   DCM  Rotational Acquisition
"""
