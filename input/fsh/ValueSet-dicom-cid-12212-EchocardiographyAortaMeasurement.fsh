...
The content in this ValueSet is based on [CID 12212](https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_12212.html).
"""
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value  = "urn:oid:1.2.840.10008.6.1.605"
* ^version = "20030918"
* ^title = "Echocardiography Aorta Measurement (CID 12212)"
