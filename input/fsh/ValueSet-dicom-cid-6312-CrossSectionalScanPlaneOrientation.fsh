...
Description :
"""
This Context Group contains terms to conveniently and explicitly describe scan plane orientation used for a specific acquisition type.       Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Sagittal   SCT  Axial   SCT  Coronal   SCT  Oblique  
"""
