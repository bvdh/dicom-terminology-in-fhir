CodeSystem: DICOMModalityLutAndRescaleType
Id: dicom-modality-lut-and-rescale-type
Title: "DICOM® Modality LUT and Rescale Type"
Description: "DICOM® Modality LUT and Rescale Type extracted from DICOM PS3.3 Table C.11-1."
* ^caseSensitive = true
* ^content = #complete
* ^experimental = false
