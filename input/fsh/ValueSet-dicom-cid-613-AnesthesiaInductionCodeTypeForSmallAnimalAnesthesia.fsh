ValueSet    : CID_613
Id          : dicom-cid-613-AnesthesiaInductionCodeTypeForSmallAnimalAnesthesia
Description :
"""
      Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID  SCT  Intraperitoneal route   The intraperitoneal route is added to the AQI value set, since that route is used for small animal imaging.
"""
