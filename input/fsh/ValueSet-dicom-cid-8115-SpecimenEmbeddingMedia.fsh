ValueSet    : CID_8115
Id          : dicom-cid-8115-SpecimenEmbeddingMedia
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Paraffin wax   SCT  Tissue freezing medium   SCT  Plastic   SCT  Agar   SCT  Epoxy resin   SCT  Acrylic resin
"""
