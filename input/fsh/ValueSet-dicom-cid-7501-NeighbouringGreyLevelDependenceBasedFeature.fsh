ValueSet    : CID_7501
Id          : dicom-cid-7501-NeighbouringGreyLevelDependenceBasedFeature
Description :
"""
      Coding Scheme Designator Code Value Code Meaning IBSI SODN Low dependence emphasis IBSI IMOQ High dependence emphasis IBSI TL9H Low grey level count emphasis IBSI OAE7 High grey level count emphasis IBSI EQ3F Low dependence low grey level emphasis IBSI JA6D Low dependence high grey level emphasis IBSI NBZI High dependence low grey level emphasis IBSI 9QMG High dependence high grey level emphasis IBSI FP8K Grey level non-uniformity of NGLDM IBSI 5SPA Normalized grey level non-uniformity of NGLDM IBSI Z87G Dependence count non-uniformity IBSI OKJI Dependence count non-uniformity normalized IBSI 6XV8 Dependence count percentage IBSI 1PFV Grey level variance of NGLDM IBSI DNX2 Dependence count variance IBSI FCBV Dependence count entropy IBSI CAS9 Dependence count energy
"""
