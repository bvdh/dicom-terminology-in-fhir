ValueSet    : CID_4256
Id          : dicom-cid-4256-VisualFieldProcedureModifier
Description :
"""
      Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Screening   SCT  Diagnostic  
"""
