ValueSet    : CID_12273
Id          : dicom-cid-12273-CardiacUltrasoundAorticSinotubularJunctionMeasurement
Description :
"""
      Coding Scheme Designator Code Value Code Meaning UMLS Concept Unique ID    LN  Aortic Sinotubular Junction to Aortic Root Ratio 
"""
