ValueSet    : CID_3613
Id          : dicom-cid-3613-HemodynamicTimeMeasurement
Description :
"""
      Coding Scheme Designator Code Value Code Meaning DCM  R-R interval DCM  Tau DCM  Left Ventricular ejection time DCM  Left Ventricular filling time DCM  Right Ventricular ejection time DCM  Right Ventricular filling time DCM  Indicator mean transit time
"""
