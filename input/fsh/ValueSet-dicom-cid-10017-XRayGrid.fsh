ValueSet    : CID_10017
Id          : dicom-cid-10017-XRayGrid
Description :
"""
      Coding Scheme Designator Code Value Code Meaning DCM  Fixed grid DCM  Focused grid DCM  Reciprocating grid DCM  Parallel grid DCM  Crossed grid DCM  No grid DCM  Virtual grid
"""
