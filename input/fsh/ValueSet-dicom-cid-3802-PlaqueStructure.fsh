...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  fibrous   SCT  fatty degeneration   SCT  pathologic calcification   SCT  hyperplasia   SCT  non-calcified   SCT  mixed
"""
