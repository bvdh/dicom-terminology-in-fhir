...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID  SCT  Transverse   DCM  Anterior-Posterior
"""
...
* DICOMDCMCodeSystem#122675 "Anterior-Posterior" 
