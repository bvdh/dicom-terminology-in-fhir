ValueSet    : CID_6318
Id          : dicom-cid-6318-ProstateDWIMRIQualityFinding
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID DCM  Expected b-value is missing   DCM  Severe distortion in the area of interest   DCM  Expected ADC map is missing   DCM  Distortion artifact in the area of interest
"""
