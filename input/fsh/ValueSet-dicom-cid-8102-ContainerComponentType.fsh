...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID  SCT  Microscope slide cover slip   SCT  Microscope slide mounting media   SCT  Specimen container lid
"""
