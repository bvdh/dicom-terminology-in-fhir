ValueSet    : CID_3232
Id          : dicom-cid-3232-STSegmentLocation
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Left ventricle anterior segment   SCT  Left ventricle inferior segment   SCT  Left ventricle lateral segment   SCT  Left ventricle septal segment   SCT  Left ventricle apical segment
"""
