ValueSet    : CID_10016
Id          : dicom-cid-10016-AnodeTargetMaterial
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Molybdenum   SCT  Rhodium   SCT  Tungsten
"""
