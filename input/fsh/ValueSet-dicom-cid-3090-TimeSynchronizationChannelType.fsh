ValueSet    : CID_3090
Id          : dicom-cid-3090-TimeSynchronizationChannelType
Description :
"""
      Coding Scheme Designator Code Value Code Meaning DCM  Digital timecode (NOS) DCM  ECG-based gating signal, processed DCM  IRIG-B timecode DCM  X-Ray Fluoroscopy On Signal DCM  X-Ray On Trigger
"""
