ValueSet    : CID_3203
Id          : dicom-cid-3203-ExerciserDevice
Description :
"""
      Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Bicycle ergometer   SCT  Treadmill   SCT  Arm ergometer  
"""
