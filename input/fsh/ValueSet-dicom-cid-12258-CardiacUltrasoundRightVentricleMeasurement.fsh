ValueSet    : CID_12258
Id          : dicom-cid-12258-CardiacUltrasoundRightVentricleMeasurement
Description :
"""
      Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID       SCT  Volume  
"""
