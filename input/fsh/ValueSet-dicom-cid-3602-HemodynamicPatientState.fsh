...
Description :
"""
Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID SCT  Baseline state   SCT  Supine body position   SCT  Resting state   SCT  Exercise state   SCT  Post-exercise state
"""
