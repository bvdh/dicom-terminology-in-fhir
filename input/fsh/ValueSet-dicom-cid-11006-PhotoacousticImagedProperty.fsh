...
Description :
"""
      Coding Scheme Designator Code Value Code Meaning SNOMED-RT ID UMLS Concept Unique ID DCM  Blood Oxygenation Level   DCM  Blood Deoxygenation Level   SCT  Hemoglobin   DCM  Elasticity   DCM  Perfusion   SCT  Melanin   SCT  Water   SCT  Lipid  
"""
