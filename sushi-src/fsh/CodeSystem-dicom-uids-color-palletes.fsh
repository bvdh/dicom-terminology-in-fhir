...
* #1.2.840.10008.1.5.1 "Hot Iron" "Hot Iron (HOT_IRON) from section sect_B.1.1. See also sect_B.1.1"
* #1.2.840.10008.1.5.1 ^property[0].code = #label
* #1.2.840.10008.1.5.1 ^property[0].valueString  = "HOT_IRON"

* #1.2.840.10008.1.5.2 "PET" "PET (PET) from section sect_B.1.2. See also sect_B.1.2"
* #1.2.840.10008.1.5.2 ^property[0].code = #label
* #1.2.840.10008.1.5.2 ^property[0].valueString  = "PET"

* #1.2.840.10008.1.5.3 "Hot Metal Blue" "Hot Metal Blue (HOT_METAL_BLUE) from section sect_B.1.3. See also sect_B.1.3"
* #1.2.840.10008.1.5.3 ^property[0].code = #label
* #1.2.840.10008.1.5.3 ^property[0].valueString  = "HOT_METAL_BLUE"

* #1.2.840.10008.1.5.4 "PET 20 Step" "PET 20 Step (PET_20_STEP) from section sect_B.1.4. See also sect_B.1.4"
* #1.2.840.10008.1.5.4 ^property[0].code = #label
* #1.2.840.10008.1.5.4 ^property[0].valueString  = "PET_20_STEP"

* #1.2.840.10008.1.5.5 "Spring" "Spring (SPRING) from section sect_B.1.5. See also sect_B.1.5"
* #1.2.840.10008.1.5.5 ^property[0].code = #label
* #1.2.840.10008.1.5.5 ^property[0].valueString  = "SPRING"

* #1.2.840.10008.1.5.6 "Summer" "Summer (SUMMER) from section sect_B.1.6. See also sect_B.1.6"
* #1.2.840.10008.1.5.6 ^property[0].code = #label
* #1.2.840.10008.1.5.6 ^property[0].valueString  = "SUMMER"

* #1.2.840.10008.1.5.7 "Fall" "Fall (FALL) from section sect_B.1.7. See also sect_B.1.7"
* #1.2.840.10008.1.5.7 ^property[0].code = #label
* #1.2.840.10008.1.5.7 ^property[0].valueString  = "FALL"

* #1.2.840.10008.1.5.8 "Winter" "Winter (WINTER) from section sect_B.1.8. See also sect_B.1.8"
