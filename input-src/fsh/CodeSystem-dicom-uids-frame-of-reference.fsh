...
* #1.2.840.10008.1.4.2.1 "ICBM 452 T1 Frame of Reference" "ICBM 452 T1 Frame of Reference (ICBM452T1) from ICBM452 T1 Atlashttp://resource.loni.usc.edu/atlasfiles/ICBM_452_T1_Atlas_Affine_Transformations.zip"
* #1.2.840.10008.1.4.2.1 ^property[0].code = #keyword
* #1.2.840.10008.1.4.2.1 ^property[0].valueString  = "ICBM452T1"

* #1.2.840.10008.1.4.2.2 "ICBM Single Subject MRI Frame of Reference" "ICBM Single Subject MRI Frame of Reference (ICBMSingleSubjectMRI) from ICBM Single Subject MRI Anatomical Templatehttp://resource.loni.usc.edu/atlasfiles/ICBM_Single_Subject_MRI_Anatomical_Template.zip"
* #1.2.840.10008.1.4.2.2 ^property[0].code = #keyword
* #1.2.840.10008.1.4.2.2 ^property[0].valueString  = "ICBMSingleSubjectMRI"

* #1.2.840.10008.1.4.3.1 "IEC 61217 Fixed Coordinate System Frame of Reference" "IEC 61217 Fixed Coordinate System Frame of Reference (IEC61217FixedCoordinateSystem) from Fixed coordinate system ('f') ofbiblio_IEC61217-2 PS3.3 C.36.12.2.1 IEC 61217 Fixed Reference System Frame of Reference"
* #1.2.840.10008.1.4.3.1 ^property[0].code = #keyword
* #1.2.840.10008.1.4.3.1 ^property[0].valueString  = "IEC61217FixedCoordinateSystem"

* #1.2.840.10008.1.4.3.2 "Standard Robotic-Arm Coordinate System Frame of Reference" "Standard Robotic-Arm Coordinate System Frame of Reference (StandardRoboticArmCoordinateSystem) from SeePS3.3 C.36.12.2.2 Standard Robotic-Arm Coordinate System Frame of Reference"
...
* #1.2.840.10008.1.4.3.3 "IEC 61217 Table Top Coordinate System Frame of Reference" "IEC 61217 Table Top Coordinate System Frame of Reference (IEC61217TableTopCoordinateSystem) from Table top coordinate system ('t') ofbiblio_IEC61217-2"
