...
* #1.2.840.10008.1.4.1.2 "SPM2 T1 Frame of Reference" "SPM2 T1 Frame of Reference (SPM2T1) from"
* #1.2.840.10008.1.4.1.2 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.2 ^property[0].valueString  = "SPM2T1"

* #1.2.840.10008.1.4.1.3 "SPM2 T2 Frame of Reference" "SPM2 T2 Frame of Reference (SPM2T2) from"
* #1.2.840.10008.1.4.1.3 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.3 ^property[0].valueString  = "SPM2T2"

* #1.2.840.10008.1.4.1.4 "SPM2 PD Frame of Reference" "SPM2 PD Frame of Reference (SPM2PD) from"
* #1.2.840.10008.1.4.1.4 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.4 ^property[0].valueString  = "SPM2PD"

* #1.2.840.10008.1.4.1.5 "SPM2 EPI Frame of Reference" "SPM2 EPI Frame of Reference (SPM2EPI) from"
* #1.2.840.10008.1.4.1.5 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.5 ^property[0].valueString  = "SPM2EPI"

* #1.2.840.10008.1.4.1.6 "SPM2 FIL T1 Frame of Reference" "SPM2 FIL T1 Frame of Reference (SPM2FILT1) from"
* #1.2.840.10008.1.4.1.6 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.6 ^property[0].valueString  = "SPM2FILT1"

* #1.2.840.10008.1.4.1.7 "SPM2 PET Frame of Reference" "SPM2 PET Frame of Reference (SPM2PET) from"
* #1.2.840.10008.1.4.1.7 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.7 ^property[0].valueString  = "SPM2PET"

* #1.2.840.10008.1.4.1.8 "SPM2 TRANSM Frame of Reference" "SPM2 TRANSM Frame of Reference (SPM2TRANSM) from"
* #1.2.840.10008.1.4.1.8 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.8 ^property[0].valueString  = "SPM2TRANSM"

* #1.2.840.10008.1.4.1.9 "SPM2 SPECT Frame of Reference" "SPM2 SPECT Frame of Reference (SPM2SPECT) from"
* #1.2.840.10008.1.4.1.9 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.9 ^property[0].valueString  = "SPM2SPECT"

* #1.2.840.10008.1.4.1.10 "SPM2 GRAY Frame of Reference" "SPM2 GRAY Frame of Reference (SPM2GRAY) from"
* #1.2.840.10008.1.4.1.10 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.10 ^property[0].valueString  = "SPM2GRAY"

* #1.2.840.10008.1.4.1.11 "SPM2 WHITE Frame of Reference" "SPM2 WHITE Frame of Reference (SPM2WHITE) from"
* #1.2.840.10008.1.4.1.11 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.11 ^property[0].valueString  = "SPM2WHITE"

* #1.2.840.10008.1.4.1.12 "SPM2 CSF Frame of Reference" "SPM2 CSF Frame of Reference (SPM2CSF) from"
* #1.2.840.10008.1.4.1.12 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.12 ^property[0].valueString  = "SPM2CSF"

* #1.2.840.10008.1.4.1.13 "SPM2 BRAINMASK Frame of Reference" "SPM2 BRAINMASK Frame of Reference (SPM2BRAINMASK) from"
* #1.2.840.10008.1.4.1.13 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.13 ^property[0].valueString  = "SPM2BRAINMASK"

* #1.2.840.10008.1.4.1.14 "SPM2 AVG305T1 Frame of Reference" "SPM2 AVG305T1 Frame of Reference (SPM2AVG305T1) from"
* #1.2.840.10008.1.4.1.14 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.14 ^property[0].valueString  = "SPM2AVG305T1"

* #1.2.840.10008.1.4.1.15 "SPM2 AVG152T1 Frame of Reference" "SPM2 AVG152T1 Frame of Reference (SPM2AVG152T1) from"
* #1.2.840.10008.1.4.1.15 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.15 ^property[0].valueString  = "SPM2AVG152T1"

* #1.2.840.10008.1.4.1.16 "SPM2 AVG152T2 Frame of Reference" "SPM2 AVG152T2 Frame of Reference (SPM2AVG152T2) from"
* #1.2.840.10008.1.4.1.16 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.16 ^property[0].valueString  = "SPM2AVG152T2"

* #1.2.840.10008.1.4.1.17 "SPM2 AVG152PD Frame of Reference" "SPM2 AVG152PD Frame of Reference (SPM2AVG152PD) from"
* #1.2.840.10008.1.4.1.17 ^property[0].code = #keyword
* #1.2.840.10008.1.4.1.17 ^property[0].valueString  = "SPM2AVG152PD"

* #1.2.840.10008.1.4.1.18 "SPM2 SINGLESUBJT1 Frame of Reference" "SPM2 SINGLESUBJT1 Frame of Reference (SPM2SINGLESUBJT1) from"
...
* #1.2.840.10008.1.4.4.1 "SRI24 Frame of Reference" "SRI24 Frame of Reference (SRI24) from"
* #1.2.840.10008.1.4.4.1 ^property[0].code = #keyword
* #1.2.840.10008.1.4.4.1 ^property[0].valueString  = "SRI24"

* #1.2.840.10008.1.4.5.1 "Colin27 Frame of Reference" "Colin27 Frame of Reference (Colin27) from"
* #1.2.840.10008.1.4.5.1 ^property[0].code = #keyword
* #1.2.840.10008.1.4.5.1 ^property[0].valueString  = "Colin27"

* #1.2.840.10008.1.4.6.1 "LPBA40/AIR Frame of Reference" "LPBA40/AIR Frame of Reference (LPBA40AIR) from"
* #1.2.840.10008.1.4.6.1 ^property[0].code = #keyword
* #1.2.840.10008.1.4.6.1 ^property[0].valueString  = "LPBA40AIR"

* #1.2.840.10008.1.4.6.2 "LPBA40/FLIRT Frame of Reference" "LPBA40/FLIRT Frame of Reference (LPBA40FLIRT) from"
* #1.2.840.10008.1.4.6.2 ^property[0].code = #keyword
* #1.2.840.10008.1.4.6.2 ^property[0].valueString  = "LPBA40FLIRT"

* #1.2.840.10008.1.4.6.3 "LPBA40/SPM5 Frame of Reference" "LPBA40/SPM5 Frame of Reference (LPBA40SPM5) from"
