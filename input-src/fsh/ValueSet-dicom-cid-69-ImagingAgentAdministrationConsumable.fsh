...
Description :
"""
The concept for syringe (physical object) is used in this Context Group as distinct from syringe (unit of presentation), which is used insect_CID_68
"""
...
* http://terminology.hl7.org/CodeSystem/umls#C0175730 "Tube" 
