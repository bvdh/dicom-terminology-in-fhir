...
* #AeApplicationEntity "AE Application Entity" 
"""
...
* #AtAttributeTag "AT Attribute Tag" 
"""
Ordered pair of 16-bit unsigned integers that is the Value of a Data Element Tag. Example: A Data Element Tag of (0018,00FF) would be encoded as a series of 4 bytes in a Little-Endian Transfer Syntax as 18H,00H,FFH,00H. Note:The encoding of an AT Value is exactly the same as the encoding of a Data Element Tag as defined in
not applicable
"""

* #CsCodeString "CS Code String" 
"""
A string of characters identifying a controlled concept. Leading or trailing spaces (20H) are not significant. Alternatively, in the context of a Query with Empty Value Matching (see
Uppercase characters, '0'-'9', the SPACE character, and underscore '_', of the Default Character Repertoire In the context of a Query with Empty Value Matching (see
"""
...
* "19930822" would represent August 22, 1993. Note:
 ...
 3 Dates before year 1582, e.g., used for dating historical or archeological items, are interpreted as proleptic Gregorian calendar dates, unless otherwise specified. Alternatively, in the context of a Query with Empty Value Matching (see
"0"-"9" of Default Character Repertoire In the context of a Query with Range Matching (see In the context of a Query with Empty Value Matching (see
"""

* #DsDecimalString "DS Decimal String" 
"""
...
"0"-"9", "+", "-", "." and the SPACE character of Default Character Repertoire In the context of a Query with Empty Value Matching (see
"""

* #FlFloatingPointSingle "FL Floating Point Single" 
"""
Single precision binary floating point value represented in
not applicable
"""

* #FdFloatingPointDouble "FD Floating Point Double" 
"""
Double precision binary floating point value represented in
not applicable
"""

* #IsIntegerString "IS Integer String" 
"""
A string of characters representing an Integer in base-10 (decimal), shall contain only the characters 0 - 9, with an optional leading '+' or '-'. It may be padded with leading and/or trailing spaces. Embedded spaces are not allowed. The integer, n, represented shall be in the range: - 2
"0"-"9", "+", "-" and the SPACE character of Default Character Repertoire
"""

* #LoLongString "LO Long String" 
"""
...
* #OdOtherDouble "OD Other Double" 
"""
A stream of
not applicable
"""

* #OfOtherFloat "OF Other Float" 
"""
A stream of
not applicable
"""

* #OlOtherLong "OL Other Long" 
"""
...
* #OvOther64-bitVeryLong "OV Other 64-bit Very Long" 
"""
...
* #SlSignedLong "SL Signed Long" 
"""
Signed binary integer 32 bits long in 2's complement form. Represents an integer n in the range: - 2
not applicable
"""

* #SqSequenceOfItems "SQ Sequence of Items" 
"""
Value is a Sequence of zero or more Items, as defined in
not applicable (see
"""

* #SsSignedShort "SS Signed Short" 
"""
Signed binary integer 16 bits long in 2's complement form. Represents an integer n in the range: - 2
not applicable
"""

* #StShortText "ST Short Text" 
"""
A character string that may contain one or more paragraphs. It may contain the Graphic Character set and the Control Characters, TAB (see
Default Character Repertoire and/or as defined by (0008,0005) excluding Control Characters except TAB, LF, FF, CR (and ESC when used for
"""

* #SvSigned64-bitVeryLong "SV Signed 64-bit Very Long" 
"""
Signed binary integer 64 bits long. Represents an integer n in the range: - 2
not applicable
"""
...
A string of characters of the format HHMMSS.FFFFFF; where HH contains hours (range '00' - '23'), MM contains minutes (range '00' - '59'), SS contains seconds (range '00' - '60'), and FFFFFF contains a fractional part of a second as small as 1 millionth of a second (range '000000' - '999999'). A 24-hour clock is used. Midnight shall be represented by only '0000' since '2400' would violate the hour range.
 ...
 2 See also DT VR in this table.
 3 The SS component may have a Value of 60 only for a leap second. Alternatively, in the context of a Query with Empty Value Matching (see
"0"-"9", "." and the SPACE character of Default Character Repertoire In the context of a Query with Range Matching (see In the context of a Query with Empty Value Matching (see
"""

* #UcUnlimitedCharacters "UC Unlimited Characters" 
"""
...
* #UiUniqueIdentifier(uid) "UI Unique Identifier (UID)" 
"""
...
* #UlUnsignedLong "UL Unsigned Long" 
"""
Unsigned binary integer 32 bits long. Represents an integer n in the range: 0 <= n <= (2
not applicable
"""

* #UnUnknown "UN Unknown" 
"""
An octet-stream where the encoding of the contents is unknown (see
not applicable
"""

* #UrUniversalResourceIdentifierOrUniversalResourceLocator(uri/url) "UR Universal Resource Identifier or Universal Resource Locator (URI/URL)" 
"""
A string of characters that identifies a URI or a URL as defined in Alternatively, in the context of a Query with Empty Value Matching (see Note:Both absolute and relative URIs are permitted.
...
The subset of the Default Character Repertoire required for the URI as defined in IETF RFC3986 Section 2, plus the space (20H) character permitted only as trailing padding. Characters outside the permitted character set must be 'percent encoded'. Note:The BACKSLASH (5CH) character is among those disallowed in URIs. In the context of a Query with Empty Value Matching (see
"""

* #UsUnsignedShort "US Unsigned Short" 
"""
Unsigned binary integer 16 bits long. Represents an integer n in the range: 0 <= n <= (2
not applicable
"""

* #UtUnlimitedText "UT Unlimited Text" 
"""
A character string that may contain one or more paragraphs. It may contain the Graphic Character set and the Control Characters, TAB (see
Default Character Repertoire and/or as defined by (0008,0005) excluding Control Characters except TAB, LF, FF, CR (and ESC when used for
"""

* #UvUnsigned64-bitVeryLong "UV Unsigned 64-bit Very Long" 
"""
Unsigned binary integer 64 bits long. Represents an integer n in the range: 0 <= n <= (2
not applicable
"""
